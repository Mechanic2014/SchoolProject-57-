...
def Print_Spread_Plot(BasketName, Spread_Time_X):
    ...
    plt.ylim(0., 4.0)
    plt.xlabel('Време, часы')
    plt.ylabel('Маржа, рубли')
...
def Make_HTML_page(BasketName, GBanksBID, GBanksASK):
    ...
    text_part_1 ="""<!DOCTYPE html><html>
    <head>
    <title>""" + BasketName + """</title>
    <meta charset="utf-8">
    <style>
    table, th, td {
    ...
    if GBanksBID == [["Bad enthernet conection"], ["Bad enthernet conection"], ["Bad enthernet conection"], ["Bad enthernet conection"]]:
        HTML_Good_BID_Banks = "Плохое соединение с интернетом.Проверьте подключение к сети"
    else:
        if BasketName == "Basket_A":
            HTML_Good_BID_Banks = ""
            for i in range(len(GBanksBID[0])):
                HTML_Good_BID_Banks += str(i + 1) + ") " + "<u><i>Цена покупки: </i></u>" + str(GBanksBID[0][i][2]) + " " + "<u><i>Цена продажи: </i></u>" + str(GBanksBID[0][i][3]) + "<br>" + "<u><i>Название: </i></u>" + str(GBanksBID[0][i][4]) + "<br>" + "<u><i>Адрес: </i></u>" + str(GBanksBID[0][i][6]) + "<br>" + "<br>"
    
        if BasketName == "Basket_B":
            HTML_Good_BID_Banks = ""
            for i in range(len(GBanksBID[1])):
                HTML_Good_BID_Banks += str(i + 1) + ") " + "<u><i>Цена покупки: </i></u>" + str(GBanksBID[1][i][2]) + " " + "<u><i>Цена продажи: </i></u>" + str(GBanksBID[1][i][3]) + "<br>" + "<u><i>Название: </i></u>" + str(GBanksBID[1][i][4]) + "<br>" + "<u><i>Адрес: </i></u>" + str(GBanksBID[1][i][6]) + "<br>" + "<br>"

        if BasketName == "Basket_C":
            HTML_Good_BID_Banks = ""
            for i in range(len(GBanksBID[2])):
                HTML_Good_BID_Banks += str(i + 1) + ") " + "<u><i>Цена покупки: </i></u>" + str(GBanksBID[2][i][2]) + " " + "<u><i>Цена продажи: </i></u>" + str(GBanksBID[2][i][3]) + "<br>" + "<u><i>Название: </i></u>" + str(GBanksBID[2][i][4]) + "<br>" + "<u><i>Адрес: </i></u>" + str(GBanksBID[2][i][6]) + "<br>" + "<br>"

        if BasketName == "Basket_D":
            HTML_Good_BID_Banks = ""
            for i in range(len(GBanksBID[3])):
                HTML_Good_BID_Banks += str(i + 1) + ") " + "<u><i>Цена покупки: </i></u>" + str(GBanksBID[3][i][2]) + " " + "<u><i>Цена продажи: </i></u>" + str(GBanksBID[3][i][3]) + "<br>" + "<u><i>Название: </i></u>" + str(GBanksBID[3][i][4]) + "<br>" + "<u><i>Адрес: </i></u>" + str(GBanksBID[3][i][6]) + "<br>" + "<br>"
    ...
    if GBanksASK == [["Bad enthernet conection"], ["Bad enthernet conection"], ["Bad enthernet conection"], ["Bad enthernet conection"]]:
        HTML_Good_ASK_Banks = "Плохое соединение с интернетом.Проверьте подключение к сети"
    else:
        if BasketName == "Basket_A":
            HTML_Good_ASK_Banks = ""
            for i in range(len(GBanksASK[0])):
                HTML_Good_ASK_Banks += str(i + 1) + ") " + "<u><i>Цена покупки: </i></u>" + str(GBanksASK[0][i][2]) + " " + "<u><i>Цена продажи: </i></u>" + str(GBanksASK[0][i][3]) + "<br>" + "<u><i>Название: </i></u>" + str(GBanksASK[0][i][4]) + "<br>" + "<u><i>Адрес: </i></u>" + str(GBanksASK[0][i][6]) + "<br>" + "<br>"
    
        if BasketName == "Basket_B":
            HTML_Good_ASK_Banks = ""
            for i in range(len(GBanksASK[1])):
                HTML_Good_ASK_Banks += str(i + 1) + ") " + "<u><i>Цена покупки: </i></u>" + str(GBanksASK[1][i][2]) + " " + "<u><i>Цена продажи: </i></u>" + str(GBanksASK[1][i][3]) + "<br>" + "<u><i>Название: </i></u>" + str(GBanksASK[1][i][4]) + "<br>" + "<u><i>Адрес: </i></u>" + str(GBanksASK[1][i][6]) + "<br>" + "<br>"

        if BasketName == "Basket_C":
            HTML_Good_ASK_Banks = ""
            for i in range(len(GBanksASK[2])):
                HTML_Good_ASK_Banks += str(i + 1) + ") " + "<u><i>Цена покупки: </i></u>" + str(GBanksASK[2][i][2]) + " " + "<u><i>Цена продажи: </i></u>" + str(GBanksASK[2][i][3]) + "<br>" + "<u><i>Название: </i></u>" + str(GBanksASK[2][i][4]) + "<br>" + "<u><i>Адрес: </i></u>" + str(GBanksASK[2][i][6]) + "<br>" + "<br>"

        if BasketName == "Basket_D":
            HTML_Good_ASK_Banks = ""
            for i in range(len(GBanksASK[3])):
                HTML_Good_ASK_Banks += str(i + 1) + ") " + "<u><i>Цена покупки: </i></u>" + str(GBanksASK[3][i][2]) + " " + "<u><i>Цена продажи: </i></u>" + str(GBanksASK[3][i][3]) + "<br>" + "<u><i>Название: </i></u>" + str(GBanksASK[3][i][4]) + "<br>" + "<u><i>Адрес: </i></u>" + str(GBanksASK[3][i][6]) + "<br>" + "<br>"
...
GBanksBID = [["Bad enthernet conection"], ["Bad enthernet conection"], ["Bad enthernet conection"], ["Bad enthernet conection"]]
GBanksASK = [["Bad enthernet conection"], ["Bad enthernet conection"], ["Bad enthernet conection"], ["Bad enthernet conection"]]

Make_HTML_page("Basket_A", GBanksBID, GBanksASK)
Make_HTML_page("Basket_B", GBanksBID, GBanksASK)
Make_HTML_page("Basket_C", GBanksBID, GBanksASK)
Make_HTML_page("Basket_D", GBanksBID, GBanksASK)



driver.get('file:///home/consta/Desktop/Programing/SchoolProject/Basket_A_HTMLpage.html')
Basket_A_Handle = driver.current_window_handle
time.sleep(3)
elem = driver.find_element_by_tag_name("body")
elem.send_keys(Keys.LEFT_CONTROL + 't')

driver.get("file:///home/consta/Desktop/Programing/SchoolProject/Basket_B_HTMLpage.html")
Basket_B_Handle = driver.current_window_handle
time.sleep(3)
elem = driver.find_element_by_tag_name("body")
elem.send_keys(Keys.LEFT_CONTROL + 't')

driver.get("file:///home/consta/Desktop/Programing/SchoolProject/Basket_C_HTMLpage.html")
Basket_C_Handle = driver.current_window_handle
time.sleep(3)
elem = driver.find_element_by_tag_name("body")
elem.send_keys(Keys.LEFT_CONTROL + 't')

driver.get("file:///home/consta/Desktop/Programing/SchoolProject/Basket_D_HTMLpage.html")
Basket_D_Handle = driver.current_window_handle
time.sleep(3)
print("finished.")
...
while True:
    ...
    try:   
        ...
        #print("finished plot.")
        print("Starting to make and to refresh Basket_A html page...", end = " ")
        driver.find_element_by_tag_name("body").send_keys(Keys.ALT + Keys.NUMPAD1)
        driver.switch_to_window(Basket_A_Handle)
        Make_HTML_page("Basket_A", GBanksBID, GBanksASK)
        driver.refresh()
        print("finished.")

        print("Starting to make and to refresh Basket_B html page...", end = " ")
        driver.find_element_by_tag_name("body").send_keys(Keys.ALT + Keys.NUMPAD2)
        driver.switch_to_window(Basket_B_Handle)
        Make_HTML_page("Basket_B", GBanksBID, GBanksASK)
        driver.refresh()
        print("finished")

        print("Starting to make and to refresh Basket_C html page...", end = " ")
        driver.find_element_by_tag_name("body").send_keys(Keys.ALT + Keys.NUMPAD3)
        driver.switch_to_window(Basket_C_Handle)
        Make_HTML_page("Basket_C", GBanksBID, GBanksASK)
        driver.refresh()
        print("finished")

        print("Starting to make and to refresh Basket_D html page...", end = " ")
        driver.find_element_by_tag_name("body").send_keys(Keys.ALT + Keys.NUMPAD4)
        driver.switch_to_window(Basket_D_Handle)
        Make_HTML_page("Basket_D", GBanksBID, GBanksASK)
        driver.refresh()
        print("finished")
        ...
        Cost_Time_A.append([0, 0, v])
        Cost_Time_B.append([0, 0, v])
        Cost_Time_C.append([0, 0, v])
        Cost_Time_D.append([0, 0, v])
